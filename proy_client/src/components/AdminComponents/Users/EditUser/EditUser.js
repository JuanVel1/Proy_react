...
import { updateUser, uploadAvatar, getAvatar } from "../../../../api/user";
...
export default function EditUserForm(props) {
  ...
  const updateUserr = () => {
    ...
    console.log("typeof userUpdate.avatar", typeof userUpdate.avatar);
    if (typeof userUpdate.avatar === "object") {
      console.log("entro");
      uploadAvatar(token, userUpdate.avatar, user._id).then((response) => {
        userUpdate.avatar = response.avatarName;
        updateUser(token, userUpdate, user._id)
          .then((result) => {
