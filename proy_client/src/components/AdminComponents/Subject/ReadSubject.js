...
export default function ReadSubject({ children }) {
  ...
  return (
    <div>
      <div>
        <b>Departameto</b>: {subjectFinal.department}
        <br />
        <b>Actividad académica</b>: {subjectFinal.academic_activity}
        <br />
        <b>Código</b>: {subjectFinal.activity_code}
        <br />
        <b>Créditos</b>: {subjectFinal.number_credits}
        <br />
        <b>Versión del PIAA</b>: {subjectFinal.piaa_version}
        <br />
        <b>Número de acta</b>: {subjectFinal.file_number.month_file}-
        {subjectFinal.file_number.year_file}
        <br />
        <b>Fecha de acta</b>: {new Date(subjectFinal.file_date).getDay()}/
        {new Date(subjectFinal.file_date).getMonth()}/
        {new Date(subjectFinal.file_date).getFullYear()}
        <br />
        <br />
      </div>
      <table>
